...
public class PreOrderFactory {
	 private static final Logger LOGGER = Logger.getLogger(PreOrderFactory.class.getName());

	public PreOrderFactory() {}

	 public static PreOrder createPreOrder(String fullyQualifiedName, Object ... base)
    {
        PreOrder record = null;
		try {
            ...
            for (int i = 0; i < constructorList.length; i++) {
              try {
            	...
            	record = (PreOrder) constructor.newInstance(base);
            ...
            LOGGER.severe("Failed to create instance of PreOrder.");
